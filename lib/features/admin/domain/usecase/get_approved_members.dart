...
class GetApprovedMembers implements UseCase<List<FamilyUserEntity>, int> {
  final OnboardingRepository repository;

  GetApprovedMembers(this.repository);

  @override
  Future<Either<Failure, List<FamilyUserEntity>>> call(int familyId) {
    return repository.getApprovedMembers(familyId: familyId);
  }
}
