        ...
        children: [
          ...
          _buildSettingsCard(children: [
            _buildSettingsTile(
              ...
              subtitle: 'Cập nhật tên, ảnh bìa & mô tả dòng họ',
            ...
            _buildSettingsTile(
              ...
              subtitle: 'Bàn giao quyền quản lý dòng họ cho người khác',
          ...
          _buildSettingsCard(children: [
            _buildSettingsTile(
              ...
              title: 'Ngôn ngữ',
              subtitle: 'Chọn ngôn ngữ hiển thị (Tiếng Việt / English)',
          ...
          _buildSettingsCard(children: [
            _buildSettingsTile(
              ...
              subtitle: 'Điều khoản sử dụng Gia Tộc Việt',
            ...
            _buildSettingsTile(
              ...
              subtitle: 'Hỗ trợ kỹ thuật và câu hỏi thường gặp',
            ...
            _buildSettingsTile(
              ...
              title: 'Về chúng tôi',
              subtitle: 'Sứ mệnh và thông tin ứng dụng',
          ...
          _buildSettingsCard(children: [
            _buildSettingsTile(
              ...
              subtitle: 'Xóa vĩnh viễn dữ liệu cây gia phả dòng họ',
