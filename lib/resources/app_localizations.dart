...
abstract class AppLocalizations {
  ...
  String generationBadge(String gen);
  String branchBadge(String name);
  String get editLabel;
  String get deleteLabel;
  String memberCountBadge(int count);
  String founderBadge(String name);
  ...
  String deleteMemberMessage(String name);
